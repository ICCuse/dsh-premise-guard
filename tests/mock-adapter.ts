/**
 * Vendored minimal mock adapter for the pain-point-check test suite.
 * Copied from the DeepSeek Harness monorepo
 * (packages/core/agent-loop/tests/mock-adapter.ts), MIT licensed, and trimmed
 * to what this suite needs: scripted text / tool-call responses with no
 * network. The full original also supports max-tokens finishes and hang
 * markers; those paths are not exercised here.
 */
